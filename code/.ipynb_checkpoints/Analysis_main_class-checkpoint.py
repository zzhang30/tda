...
def main():
    ...
    plot_and_save_barcode(simplex_tree, output_name="ivy_main_class_barcode")

    # Step 6: Plot and save persistence diagram
    plot_and_save_persistence_diagram(simplex_tree, output_name="ivy_main_class_persistence_diagram")
